...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
          ...
          <h1>Order</h1>
      <div class="frame">
      <button onclick="location.href='history.php';" class="custom-btn btn-7" type="button"><span>ประวัติการสั่งซื้อ</span></button>
      </div>
            <br>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM order_head WHERE o_email='$email' and status='1' or status='2' or status='4'";
