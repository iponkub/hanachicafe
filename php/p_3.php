    ...
    <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="p_3.php" class="list-group-item list-group-item-action active">สถานะอาหาร</a>
        ...
        <div class="col-md-10">
          <h1>Food</h1>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM order_head WHERE status='2'";
...
<!-- Status-Modals -->
<div class="modal fade" id="statusmodal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="o_status_2.php?o_id=<?php echo $id ?>" class="row g-3" enctype="multipart/form-data">
      <div class="modal-header">
        <h5 class="modal-title" id="addModalLabel">::: เปลี่ยนสถาณะอาหาร</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <div class="col-md-12">
            <label class="text-secondary">Change/Status</label>
            <select class="form-select" aria-label="" name="stat">
            <option selected>เลือก สถานะอาหาร</option>
                <option value="3">กำลังจัดส่ง</option>
                <option value="4">รับที่ร้าน</option>
            </select>
        </div>
      </div>
