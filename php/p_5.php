    ...
    <div class="row">
        <div class="col-md-2">
          <div class="list-group">
            ...
            <a href="p_5.php" class="list-group-item list-group-item-action active">ประวัติการถูกสั่งซื้อ</a>
          </div>
        </div>
        <div class="col-md-10">
          <h1>History</h1>
            ...
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM order_head WHERE status='4' or status='5' or status='6'";
